# 1주차에는 파이게임을 공부하여 간단한 게임을 다같이 만들었습니다.
# 파이썬의 기초문법만 알고있는 상태에서 
# 게임을 만들면서 객체지향 프로그래밍에 대해서 더욱 알게 되었고
# os나 fps속도 조정 등 다양한 함수/문법 또한 습득하였습니다.
...
stage_height = stage_size[1] # 스테이지의 높


# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "c2.png"))
